# MaterialM - Complete AI Instructions
...
**MaterialM** is a modern Next.js admin dashboard template built with TypeScript, Tailwind CSS, and shadcn/ui components. It features:
