                ...
                <div className="w-full flex flex-col gap-12">
                    ...
                    >
                        ...
                        <p className=" text-sm text-muted-foreground">
                            ...
                            explain much to your AI assistant. Material-M provides
                        ...
                        >
                            ...
                            <div className="absolute top-1/2 inset-x-6 -translate-y-1/2 bg-gray-950/60 px-2 py-2.5 sm:p-4 rounded-xl flex flex-col gap-3 text-white max-h-[80%] overflow-hidden">
                                <pre className="whitespace-pre-wrap text-[10px] leading-relaxed sm:text-xs md:text-sm overflow-hidden">
                                    {`# Material-M - Complete AI Instructions
...
## Project Overview
**Material-M** is a modern open-source Next.js admin dashboard template built with TypeScript, Tailwind CSS, and shadcn/ui components. It features:
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-6 h-full">
                                ...
                                >
                                    ...
                                    <Link
                                        href={"#prompt-library"}
                                        className="w-fit group bg-gray-200 hover:bg-gray-200/80 h-auto px-5 py-2.5 flex items-center gap-2 rounded-full text-gray-950 cursor-pointer font-medium text-sm"
                                    >
