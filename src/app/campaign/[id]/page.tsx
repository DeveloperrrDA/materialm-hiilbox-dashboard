      ...
      <div className="mx-auto max-w-[1218px] px-6 py-10">
        <div className="grid gap-12 lg:grid-cols-[1fr_380px]">
          ...
          <div className="rounded-[20px] border border-[#e0e6eb] bg-white p-6 shadow-[0_12px_32px_rgba(17,28,45,0.05)] sm:p-8">
            ...
            <section className="mt-8 rounded-[16px] border border-[#e0e6eb] p-6">
          ...
          <aside>
            <div className="sticky top-28">
              <div className="relative overflow-hidden rounded-[20px] bg-white p-6 shadow-[0_16px_40px_rgba(17,28,45,0.09)] ring-1 ring-[#e0e6eb] before:absolute">
                <div className="absolute inset-x-0 top-0 h-1 bg-[#01A14B]" />
                <p className="mb-5 text-xs font-bold uppercase tracking-[0.16em] text-[#01A14B]">Campaign progress</p>
