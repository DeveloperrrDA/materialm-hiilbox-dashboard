<!-- DESCRIPTION: Completely Remove a Language from the MaterialM
...
You are a Senior Frontend Developer. Your task is to completely remove support for a specific language from MaterialM.
