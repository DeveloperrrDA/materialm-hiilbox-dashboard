...
You are a Senior Frontend Developer. Your task is to update the navigation menus in MaterialM. You must ensure that changes are reflected in both the **Vertical Sidebar** and the **Horizontal Menu**.
